...
contract MyFirstNFTB is ERC721, ERC721URIStorage, Ownable {
    ...
    constructor(string memory theBaseURI) ERC721("My FirstNFTB", "NFTB") {
    ...
    function awardItem(address recipient, string memory hash, string memory metadata) external onlyOwner returns (uint256)
    {
        ...
        //only 10000 items can be minted, even by owner
        //If ownership renounced, no one can mint ever again
        require(newItemId < 10000);
